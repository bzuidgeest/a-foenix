 ...
 * mapping. */
char *_keyboard_common_names[KEY_MAX] =
{
   "(none)",     "A",          "B",          "C",
   "D",          "E",          "F",          "G",
   "H",          "I",          "J",          "K",
 ...
 */
//inline
static void add_key(volatile KEY_BUFFER *buffer, int key, int scancode)
{
   int c, d;
 ...
 */
// INLINE
static void update_shifts(void)
{
